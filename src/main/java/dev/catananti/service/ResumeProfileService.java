...
public class ResumeProfileService {
    ...
    private Mono<ResumeProfile> updateExistingProfile(ResumeProfile existing, ResumeProfileRequest request) {
        ...
        existing.setLinkedin(request.getLinkedin());
        existing.setGithub(request.getGithub());
    ...
    private String renderHtml(ResumeProfileResponse profile, String lang) {
        ...
        if (profile.getLocation() != null) contactParts.add(escapeHtml(profile.getLocation()));
        if (profile.getEmail() != null) contactParts.add(escapeHtml(profile.getEmail()));
        if (profile.getLinkedin() != null) contactParts.add(escapeHtml(profile.getLinkedin()));
        if (profile.getGithub() != null) contactParts.add(escapeHtml(profile.getGithub()));
        if (profile.getWebsite() != null) contactParts.add(escapeHtml(profile.getWebsite()));
        if (profile.getPhone() != null) contactParts.add(escapeHtml(profile.getPhone()));
